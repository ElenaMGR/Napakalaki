...
public class Player {
    ...
    protected boolean shouldConvert(){
        ...
        int n = d.nextNumber("Lanzamiento de Dado "+getName(),"¿Debes convertirte en Sectario?");
        if (n==1)
            shouldC=true;
        else
            shouldC=false;
   ...
   // Devuelve la vida al jugador, modificando el atributo correspondiente
    ...
    public void initTreasures(){
        ...
        hiddenTreasures.add(treasure);
        int number = dice.nextNumber("Lanzamiento de Dado "+getName(),"¿Cuantas cartas robarás?");
